...
class Alg_WC_AEP_Settings_Multiple_URLs extends Alg_WC_AEP_Settings_Section {
	 ...
	 * @since   2.3.0
	 *
	 * @todo    (desc) `alg_wc_external_products_multiple_urls_enabled`: better desc?
	 */
		...
		return array(
			...
			array(
				...
				'desc'              => apply_filters(
					...
					sprintf(
						'To select a template, please get the <a target="_blank" href="%s">Multiple External Products URLs & Currencies for WooCommerce Pro</a> plugin.',
